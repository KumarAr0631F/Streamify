              ...
              <div className='space-y-4'>
                ...
                <div className='flex flex-col gap-3'>
                  <div className='form-control w-full'> 
                    ...
                    <input type="email" placeholder='john.doe@example.com' className='input input-bordered w-full' value={loginData.email} onChange={(e) => setLoginData({ ...loginData, email: e.target.value })} />
                  </div>
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            <div className='relative aspect-square max-w-sm mx-auto'>
              <img src="/call-image.png" alt="Language connection illustration" className='w-full h-full' />
            </div>
