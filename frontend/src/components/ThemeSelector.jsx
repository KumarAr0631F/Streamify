...
const ThemeSelector = () => {
  ...
  return (
    <div className='dropdown dropdown-end'>
        ...
        <div tabIndex={0} className='dropdown-content mt-2 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-3xl w-56 border-base-content/10 max-h-80 overflow-y-auto'>
